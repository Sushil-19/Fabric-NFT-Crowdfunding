...
const fabricService_1 = require("./fabricService");
...
const fabricProjectPath = path_1.default.resolve(__dirname, '../../'); // Adjust this path as needed
const fabricService = new fabricService_1.FabricService(fabricProjectPath);
// Routes
/**
